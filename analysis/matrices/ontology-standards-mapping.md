...
|:--|:--|:--|:--|:--|
| 概念/术语体系 | ✅ SID vs Ontology（TIO）已核实 [8] [高]；计划中的 Federated Ontology（GB1093）仅标题级 [1] [低] | 🟡 使用 Information model / NRM / Intent IOC；研究中出现 knowledge/semantic；Rel-20 工作区 §2.2.4 WT-4 计划调研 TMF 本体/RDF/KG [2] [高] | ✅ 「本体模型 / 实例化模型 / 知识图谱」写入 YD/T 7007 目录与解读 [3] [中] | ✅ M.3351 定义 knowledge / knowledge graph / ontology modelling [4] [高] |
...
| 数据与知识管理框架 | 🔬 TR311 Knowledge Manager 组件需求 [中]；TR326 Semantic Knowledge Fabric 标题级 [10] [低] | 🔬 TR 32.801-01：DMFW + Data and Knowledge Management KI [2] [高] | ✅ YD/T 7011 总体框架 + 7023 融合 + 7024 构建 [3] [高] | ✅ M.3351 六块功能框架；M.3351.2 九步构图 [4] [高] |
...
| 治理与成熟度评估 | 🔬 TR329 标题为 Ontology Programme Governance [12] [低]；GB1025 是数据治理成熟度（既有）[高] | 🟡 访问控制/用户同意在 DMFW WT 列表中，非本体治理 [2] [中] | 🟡 质量评估出现在 7024 构建过程，无成熟度等级模型 [3] [中] | 🟡 M.3351 含 validation / quality of raw data [4] [中] |
| 发布状态/公开性/主导 | TIO 公开 GA、SID 会员 [8] [高]；GB1093/TR328/329 仅 Community 标题、hub 已关 [1] [低]。主导：AN + MODA | 28.312 公开 [高]；32.801-01 草稿，**文档 rapporteur 中兴（Pengxiang Xie）；WI FS_6G_OAM rapporteur AT&T（Bahar Sadeghi）** [2] [高] | 2026-06/07 已发布，全文付费。**目录首位**：北邮/移动/电信/联通；华为与中兴起草 [3] [高] | M.3351 公开。ITU-T SG2 [4] [高] |
...
4. **华为不是 CCSA 本体的唯一作者**；中兴同等出现在多份起草名单，并额外拥有 SA5 **TR 32.801-01 文档 rapporteur**（WI 由 AT&T 牵头）。
